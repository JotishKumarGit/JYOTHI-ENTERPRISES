    ...
    <section class="breadcrumb-section text-white d-flex align-items-center">
        ...
        <div class="container text-center position-relative">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h1 class="page-title">Floor Cleaner</h1>
    ...
    <section class="container my-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12 mb-4 mb-md-0 text-center">
                <img src="assets/img/floor-cleaner.avif" alt="Floor Cleaner" class="img-fluid rounded shadow">
            </div>

            <!-- Product Details -->
            <div class="col-lg-6 col-md-6 col-12">
                <h2 class="mb-3">Floor Cleaner</h2>
                <p class="text-muted">
                    Our high-performance floor cleaner effectively removes dirt, germs,
                    and stains while leaving a refreshing fragrance. Suitable for homes,
                ...
                <ul class="list-unstyled mb-4">
                    ...
                    <li>✔ Pleasant long-lasting fragrance</li>
                    <li>✔ Safe for marble, tiles & granite</li>
                </ul>
