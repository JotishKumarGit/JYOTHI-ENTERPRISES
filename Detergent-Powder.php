    ...
    <section class="breadcrumb-section text-white d-flex align-items-center">
        ...
        <div class="container text-center position-relative">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h1 class="page-title">Detergent Powder</h1>
    ...
    <section class="container my-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12 mb-4 mb-md-0 text-center">
                <img src="assets/img/Detergent-Powder.jpg" alt="Detergent Powder" class="img-fluid rounded shadow">
            </div>

            <!-- Product Details -->
            <div class="col-lg-6 col-md-6 col-12">
                <h2 class="mb-3">Detergent Powder</h2>
                <p class="text-muted">
                    Our premium quality detergent powder is specially formulated to remove
                    tough stains while being gentle on fabrics. Suitable for both hand wash
                    and machine wash.
                </p>

                <ul class="list-unstyled mb-4">
                    <li>✔ Powerful stain removal</li>
                    <li>✔ Fresh and long-lasting fragrance</li>
                    <li>✔ Safe on all fabrics</li>
